...
console.log(10 * 10);
console.log(10 / 10);
console.log(1 / 0); // Infinity -> 무한대 | isFinite 또는 Number.isFinite() 메서드로 Infinity를 체크할 수 있음
console.log(10 % 10);
console.log(10 % 3);
...
name = name ?? '코드팩토리'; // name이 null이거나 undefined면 우측값을 반환
console.log(name);
...
let name2;
name2 ??= '코드팩토리'; // 동일한 코드 -> name = name ?? '코드팩토리' 
console.log(name2);